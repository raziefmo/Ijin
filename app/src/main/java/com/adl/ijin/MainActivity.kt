...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        RetrofitConfig().getIjin().getAllIjin().enqueue(object:Callback<GetIjinRespon>{
            override fun onResponse(
                call: Call<GetIjinRespon>,
                response: Response<GetIjinRespon>
            ) {
                Log.d("Response",response.body().toString())
            }

            override fun onFailure(call: Call<GetIjinRespon>, t: Throwable) {
